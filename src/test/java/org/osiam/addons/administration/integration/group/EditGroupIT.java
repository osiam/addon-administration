...
public class EditGroupIT extends Integrationtest {
    ...
    private void checkEmptyValidation() {
        ...
        assertTrue(browser.isTextPresent("Die Eingabe darf nicht leer sein!")
                || browser.isTextPresent("The value can\u02c8t be empty!"));
    }
    ...
    private int getAssignedUser(String visibility) {
        String userRowsXpath = "//table[contains(@id,'" + visibility
                + "')]//tr//td//input[contains(@class, 'checkbox')]";
